...
| [`ejemplos/`](ejemplos/) | Cuadernos de casos prácticos por fase: datos listos para importar, laboratorios guiados y soluciones. Se construyen fase a fase. **Disponibles: Fases 1 a 8.** |
